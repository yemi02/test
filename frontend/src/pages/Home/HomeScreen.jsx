  ...
  if (!trendingContent)
    return (
      <div className="text-white h-screen relative bg-black">
        <Navbar />
        {/* <div className="absolute top-0 left-0 bg-black/70 flex justify-center items-center w-full h-full -z-10 shimmer" /> */}
        ...
        <div className="absolute top-0 left-0 w-full h-full flex flex-col justify-center px-8 md:px-16 lg:px-32">
          ...
          <div className="max-w-2xl ">
            ...
            <p className="mt-4 text-lg">
              {trendingContent?.overview?.length > 230
                ? trendingContent?.overview?.slice(0, 230) + "..."
          ...
          <div className="flex mt-8">
            ...
            >
              <Play className="size-5 inline-block mr-2 fill-black" />
              Play
            </Link>
            <Link
              to={"/watch/123"}
